...
public class PauseMenuSimple : MonoBehaviour
{
    ...
    private void BuildSettingsUi(Font sectionFont, Font itemsFont)
    {
        ...
        sectionTitleText = CreateHeader(settingsRoot, new Vector2(settingsLabelX, y), sectionFont, menuFontSize - 2);
        ...
        y -= 78f;
        accessibilityTitleText = CreateHeader(settingsRoot, new Vector2(settingsLabelX, y), sectionFont, menuFontSize - 12);
        y -= 58f;
        CreateCycleRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, OnLanguagePressed, out languageRowLabel, out languageButton, out languageValueText);
        y -= 52f;
        CreateCycleRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, OnColorBlindPressed, out colorBlindRowLabel, out colorBlindButton, out colorBlindValueText);

        y -= 74f;
        audioTitleText = CreateHeader(settingsRoot, new Vector2(settingsLabelX, y), sectionFont, menuFontSize - 12);
        y -= 58f;
        CreateSliderRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, 0f, 10f, true, OnMasterVolumeChanged, out masterVolumeRowLabel, out masterVolumeSlider, out masterVolumeValueText);
        y -= 52f;
        CreateSliderRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, 0f, 10f, true, OnEnvironmentVolumeChanged, out environmentVolumeRowLabel, out environmentVolumeSlider, out environmentVolumeValueText);
        y -= 52f;
        CreateSliderRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, 0f, 10f, true, OnMenuVolumeChanged, out menuVolumeRowLabel, out menuVolumeSlider, out menuVolumeValueText);
        y -= 52f;
        CreateSliderRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, 0f, 10f, true, OnEffectsVolumeChanged, out effectsVolumeRowLabel, out effectsVolumeSlider, out effectsVolumeValueText);

        y -= 74f;
        screenTitleText = CreateHeader(settingsRoot, new Vector2(settingsLabelX, y), sectionFont, menuFontSize - 12);
        y -= 58f;
        CreateCycleRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, OnResolutionPressed, out resolutionRowLabel, out resolutionButton, out resolutionValueText);
        y -= 52f;
        CreateCycleRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, OnFpsPressed, out fpsRowLabel, out fpsButton, out fpsValueText);
        y -= 52f;
        CreateCycleRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, OnVsyncPressed, out vsyncRowLabel, out vsyncButton, out vsyncValueText);
        y -= 52f;
        CreateCycleRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, OnHdrPressed, out hdrRowLabel, out hdrButton, out hdrValueText);
        y -= 52f;
        CreateSliderRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, -2f, 2f, false, OnBrightnessChanged, out brightnessRowLabel, out brightnessSlider, out brightnessValueText);
        y -= 52f;
        CreateSliderRow(settingsRoot, new Vector2(settingsLabelX, y), itemsFont, -100f, 100f, false, OnContrastChanged, out contrastRowLabel, out contrastSlider, out contrastValueText);
    }
    ...
    private void AutoFindAudioLinks()
    {
        if (windNoise == null)
        {
            windNoise = Object.FindFirstObjectByType<WindNoiseGenerator>();
        }

        if (grassSteps == null)
        {
            grassSteps = Object.FindFirstObjectByType<GrassFootstepNoise>();
        }
